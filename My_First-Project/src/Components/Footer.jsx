            ...
            <Col>
              <div className="footer-section">
                ...
                <ul>
                  ...
                  <li>
                    <Link as={NavLink} to="https://www.linkedin.com/in/arham-ali-973359289/" target="_blank" className="login">
                      Linkedin
                    </Link>
                  </li>
                  <li>
                    <Link as={NavLink} to="https://github.com/arham-ali1323" target="_blank" className="login">
                      Github
                    </Link>
                  </li>
                </ul>
